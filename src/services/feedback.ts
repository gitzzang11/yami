...
> = {
  delicious: {
    ...
    activeClass: "ring-2 ring-emerald-500 bg-emerald-100 text-emerald-900 dark:bg-emerald-900 dark:text-emerald-100",
  },
  good: {
    label: "맛있음",
    emoji: "👍",
    ...
    activeClass: "ring-2 ring-sky-500 bg-sky-100 text-sky-900 dark:bg-sky-900 dark:text-sky-100",
  },
  soso: {
    label: "무난",
    emoji: "😐",
    ...
    activeClass: "ring-2 ring-zinc-500 bg-zinc-200 text-zinc-950 dark:bg-white/20 dark:text-white",
  },
  bad: {
    label: "별로",
    emoji: "🤢",
    ...
    activeClass: "ring-2 ring-rose-500 bg-rose-100 text-rose-900 dark:bg-rose-900 dark:text-rose-100",
  },
  spicy: {
    label: "매움",
    emoji: "🔥",
    ...
    activeClass: "ring-2 ring-orange-500 bg-orange-100 text-orange-900 dark:bg-orange-900 dark:text-orange-100",
  },
  little: {
    label: "양적음",
    emoji: "🤏",
    ...
    activeClass: "ring-2 ring-amber-500 bg-amber-100 text-amber-900 dark:bg-amber-900 dark:text-amber-100",
  },
};
